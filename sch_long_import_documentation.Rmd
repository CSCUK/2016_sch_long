...
population <- population %>% 
              mutate(SchemeType = 
                        ...
                        paste(Scheme) ))))))))) %>% 
                     mutate(CtteeGroup = ifelse(Scheme %in% "CR","Agency: Developed", paste(SchemeType)))
                    )
```
